...
@allure.epic("Test Character Films")
class TestCharacterFilms:

    @allure.title("Get characters from the selected character's films")
    @allure.description(
        "Get all unique characters who appeared in the same films as the selected character and save their names to a file.")
    def test_get_characters_from_films(self):
        ...
        with allure.step("Get character information"):
        ...
        with allure.step("Get films of the selected character"):
        ...
        with allure.step("Get characters from all films"):
        ...
        with allure.step("Save character names to a file"):
